...
function OtherAttachments() {
    ...
    return (
        ...
        <div className="md:container md:mx-auto px-8 md:px-8 pb-5 dark:bg-darkAccent rounded-b-3xl bg-contentBg" id="otherAttachments">
            <div className='flex flex-col border-[1px] dark:border-darkSecondary border-lightBorderColor rounded-lg md:mx-auto px-0 md:px-3  h-auto shadow-lg'>
                <div className='py-5 px-3'>
                    <h2 className='text-2xl font-semibold text-lightTextHeading'>Other Attachments</h2>
                </div>
