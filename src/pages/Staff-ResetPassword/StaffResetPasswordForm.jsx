...
const StaffResetPasswordForm = () => {
    ...
    const onSubmit = async (e) => {
        ...
        try {
            ...
            const response = await authStaffService.resetPassword({
        ...
        <form className="space-y-4 w-96  " onSubmit={onSubmit}>
            ...
            >
                ...
                <input
                    ...
                    value={identifier}
                    className="form-control w-96 rounded-md px-4 py-2 bg-[#eaeef1] outline-none   dark:bg-darkIconAndSearchBg dark:placeholder-darkPlaceholder"
                    readOnly
                />
