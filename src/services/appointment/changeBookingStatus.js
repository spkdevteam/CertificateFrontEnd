...
try {
    ...
    const response = await axios.post(`${import.meta.env.VITE_BASE_URL}/api/client/bu/booking/changeAppointmentStatus`,{...data,clientId:clientId,buId:businessUnitId}, {
        headers: {
