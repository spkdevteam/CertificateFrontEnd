...
const Login = async (data) => {
  return await axios
    .post(`${import.meta.env.VITE_BASE_URL}/api/client/auth/signIn`, data)
    .then((response) => {
...
const forgotPassword = async (data) => {
  ...
  return await axios
    .post(`${import.meta.env.VITE_BASE_URL}/api/client/auth/forgetpassword`, data)
    .then((response) => {
      return response;
    });
};
...
const resetPassword = async (data) => {
  ...
  return await axios
    .post(`${import.meta.env.VITE_BASE_URL}/api/client/auth/resetpassword`, data)
    .then((response) => {
      return response;
    });
};
...
const OtpSignIn = async (data) => {
  try {
    const response = await axios.post(
      `${import.meta.env.VITE_BASE_URL}/api/client/auth/signInByOtp`,
      data
    );
    return response;
  } catch (error) {
...
const updateProfile = async (data) => {
  ...
  try {
    const response = await axios.post(
      `${import.meta.env.VITE_BASE_URL}/api/client/auth/clientProfile`,
